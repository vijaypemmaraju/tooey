...
}`,demoSpec:'{"s":{"n":0},"r":["vs",[["tx",{"$":"n"},{"fs":24,"fg":"#0af"}],["hs",[["bt","-",{"c":["n","-"]}],["bt","+",{"c":["n","+"]}]],{"g":8}]],{"g":16,"ai":"c"}]}',reactDemoCode:`function Counter() {
...
}`,demoSpec:'{"s":{"txt":"","items":["buy milk","walk dog"]},"r":["vs",[["hs",[["in","",{"v":{"$":"txt"},"x":["txt","!"],"ph":"add item..."}],["bt","+",{"c":["items","<",{"$":"txt"}]}]],{"g":8}],{"m":"items","a":["hs",[["tx","$item",{"s":{"flex":"1"}}],["bt","x",{"c":["items","X","$index"]}]],{"g":8,"p":"8px 0","s":{"borderBottom":"1px solid #333"}}]}],{"g":12}]}',reactDemoCode:`function TodoList() {
...
}`,demoSpec:'{"s":{"name":"","email":"","agree":false},"r":["vs",[["vs",[["tx","name",{"fs":12,"fg":"#888"}],["in","",{"ph":"your name","v":{"$":"name"},"x":["name","!"]}]],{"g":4}],["vs",[["tx","email",{"fs":12,"fg":"#888"}],["in","",{"type":"email","ph":"you@example.com","v":{"$":"email"},"x":["email","!"]}]],{"g":4}],["hs",[["cb","",{"ch":{"$":"agree"},"x":["agree","~"]}],["tx","i agree to terms",{"fs":13}]],{"g":8,"ai":"c"}],["bt","sign up",{"bg":"#0af","fg":"#000","p":"10px 20px","r":4,"s":{"border":"none","cursor":"pointer"}}]],{"g":16}]}',reactDemoCode:`function Form() {
...
}`,demoSpec:'{"s":{"c":20},"r":["hs",[["vs",[["tx","celsius",{"fs":12,"fg":"#888"}],["in","",{"type":"number","v":{"$":"c"},"x":["c","!"]}]],{"g":4}],["tx","=",{"fs":24,"fg":"#0af"}],["vs",[["tx","fahrenheit",{"fs":12,"fg":"#888"}],["tx","68",{"fs":16}]],{"g":4}]],{"g":16,"ai":"c"}]}',reactDemoCode:`function TempConverter() {
...
}`,demoSpec:'{"s":{"data":[{"name":"alice","age":28,"role":"engineer"},{"name":"bob","age":34,"role":"designer"},{"name":"carol","age":25,"role":"manager"}]},"r":["vs",[["tb",[["th",[["Tr",[["tc","name",{"fg":"#0af"}],["tc","age",{"fg":"#0af"}],["tc","role",{"fg":"#0af"}]]]]],["bd",[{"m":"data","a":["Tr",[["Td","$item.name"],["Td","$item.age"],["Td","$item.role"]]]}]]]]],{"g":12}]}',reactDemoCode:`function DataTable() {
...
}`,demoSpec:'{"s":{"tab":0},"r":["vs",[["hs",[["bt","profile",{"c":["tab","!",0]}],["bt","settings",{"c":["tab","!",1]}],["bt","about",{"c":["tab","!",2]}]],{"g":0,"s":{"borderBottom":"1px solid #333"}}],{"?":"tab","is":0,"t":["tx","user profile content",{"p":16,"fg":"#ccc"}],"e":{"?":"tab","is":1,"t":["tx","settings panel",{"p":16,"fg":"#ccc"}],"e":["tx","about section",{"p":16,"fg":"#ccc"}]}}],{"g":0}]}',reactDemoCode:`function Tabs() {
...
}`,demoSpec:'{"s":{"q1":1,"q2":2},"r":["vs",[["hs",[["tx","widget",{"fg":"#ccc","s":{"flex":"1"}}],["hs",[["bt","-",{"c":["q1","-"]}],["tx",{"$":"q1"}],["bt","+",{"c":["q1","+"]}]],{"g":8,"ai":"c"}],["tx","$25",{"fg":"#0af","w":50,"ta":"rt"}]],{"jc":"sb","ai":"c","p":"8px 0","s":{"borderBottom":"1px solid #333"}}],["hs",[["tx","gadget",{"fg":"#ccc","s":{"flex":"1"}}],["hs",[["bt","-",{"c":["q2","-"]}],["tx",{"$":"q2"}],["bt","+",{"c":["q2","+"]}]],{"g":8,"ai":"c"}],["tx","$35",{"fg":"#0af","w":50,"ta":"rt"}]],{"jc":"sb","ai":"c","p":"8px 0","s":{"borderBottom":"1px solid #333"}}],["hs",[["tx","total:",{"fg":"#888"}],["tx","$95",{"fg":"#4f8","fw":600}]],{"jc":"sb","p":"16px 0"}]],{"g":0}]}',reactDemoCode:`function Cart() {
...
}`,demoSpec:'{"s":{"step":0,"name":"","email":""},"r":["vs",[["hs",[["dv","",{"w":40,"h":4,"bg":"#0af","r":2}],["dv","",{"w":40,"h":4,"bg":"#333","r":2}],["dv","",{"w":40,"h":4,"bg":"#333","r":2}]],{"g":4}],{"?":"step","is":0,"t":["vs",[["tx","step 1: name",{"fw":500,"fg":"#fff"}],["in","",{"v":{"$":"name"},"x":["name","!"],"ph":"your name"}]],{"g":12}],"e":{"?":"step","is":1,"t":["vs",[["tx","step 2: email",{"fw":500,"fg":"#fff"}],["in","",{"type":"email","v":{"$":"email"},"x":["email","!"],"ph":"email"}]],{"g":12}],"e":["vs",[["tx","done!",{"fw":600,"fg":"#4f8","fs":16}],["tx","thanks for signing up",{"fg":"#888"}]],{"g":8}]}},["hs",[["bt","back",{"c":["step","-"]}],["bt","next",{"c":["step","+"]}]],{"g":8,"jc":"fe"}]],{"g":16}]}',reactDemoCode:`function Wizard() {
...
}`,file:"09-wizard.html"}]};function W(e){if(!e||e.length<2)return[];let n=e.toLowerCase(),s=[];return r.coreFunctions.forEach(o=>{(o.name.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"function",...o})}),r.instanceMethods.forEach(o=>{(o.name.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"method",...o})}),r.components.forEach(o=>{(o.name.toLowerCase().includes(n)||o.fullName?.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"component",...o})}),r.props.forEach(o=>{(o.name.toLowerCase().includes(n)||o.fullName?.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"prop",...o})}),r.events.forEach(o=>{(o.name.toLowerCase().includes(n)||o.fullName?.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"event",...o})}),r.stateOps.forEach(o=>{(o.op?.includes(n)||o.name.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"operation",...o})}),r.controlFlow.forEach(o=>{(o.name.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"controlflow",...o})}),r.types.forEach(o=>{(o.name.toLowerCase().includes(n)||o.description.toLowerCase().includes(n))&&s.push({type:"type",...o})}),s}var E={colors:{bg:"#0a0a0f",bgSecondary:"#111118",bgTertiary:"#1a1a24",bgHover:"#252530",text:"#e0e0e0",textSecondary:"#888",textMuted:"#666",accent:"#0af",success:"#4f8",warning:"#fa0",error:"#f55",border:"#333",codeBg:"#111"},spacing:{xs:4,sm:8,md:16,lg:24,xl:32},radius:{sm:4,md:8,lg:12}},Q={colors:{bg:"#fff",bgSecondary:"#f8f9fa",bgTertiary:"#e9ecef",bgHover:"#dee2e6",text:"#212529",textSecondary:"#495057",textMuted:"#868e96",accent:"#0066cc",success:"#28a745",warning:"#ffc107",error:"#dc3545",border:"#dee2e6",codeBg:"#f4f4f4"},spacing:E.spacing,radius:E.radius},X=e=>{let n=document.documentElement;Object.entries(e.colors).forEach(([s,o])=>{n.style.setProperty(`--${s.replace(/([A-Z])/g,"-$1").toLowerCase()}`,o)})},le=()=>{if(document.getElementById("tooey-docs-styles"))return;let e=document.createElement("style");e.id="tooey-docs-styles",e.textContent=`
    pre[class*="language-"], code[class*="language-"] {
      font-family: 'SF Mono', Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace !important;
      white-space: pre-wrap !important;
      word-break: break-word !important;
    }
  `,document.head.appendChild(e)},de={name:"logger",onStateChange(e,n,s){["searchQuery","searchResults"].includes(e)||console.log(`[docs] ${e}:`,n,"\u2192",s)}},U=e=>{let n=e.size||32;return[m,"",{w:n,h:n,s:{display:"inline-block"},id:`logo-${Math.random().toString(36).slice(2,8)}`}]},ee=()=>{document.querySelectorAll('[id^="logo-"]').forEach(e=>{if(e.innerHTML)return;let n=parseInt(e.style.width)||32;e.innerHTML=`<svg width="${n}" height="${n}" viewBox="0 0 64 64" style="color: var(--accent);">
    ...
    </svg>`})},i=(e={},n=[])=>[a,n,{cls:"bg-bg-secondary p-4 rounded-lg border border-border"}],D=new Map,l=e=>{let n=`code-${Math.random().toString(36).slice(2,8)}`;return D.set(n,{code:e.code,lang:e.lang||"javascript"}),[m,"",{id:n,cls:"bg-code-bg rounded overflow-auto max-h-[300px]"}]},pe=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),me=()=>{D.forEach(({code:e,lang:n},s)=>{let o=document.getElementById(s);o&&!o.querySelector("pre")&&(o.innerHTML=`<pre style="margin:0;padding:8px;font-size:12px;line-height:1.4;"><code class="language-${n}">${pe(e)}</code></pre>`)}),D.clear()},p=e=>[a,[[t,e.title,{cls:"text-xs font-normal text-text-muted uppercase tracking-wider block"}],e.subtitle?[t,e.subtitle,{cls:"text-sm text-text-secondary mt-1"}]:null].filter(Boolean),{cls:"mb-4"}],G=e=>{let{item:n,type:s}=e,o=[[c,[[t,s,{cls:"text-[10px] text-accent bg-bg-tertiary px-2 py-0.5 rounded uppercase"}],[t,n.name||n.op||n.fullName||"",{cls:"text-lg font-semibold text-text-primary"}]],{cls:"gap-2 items-center flex"}],[t,n.description,{cls:"text-text-secondary my-2 mb-4 block"}]];return n.signature&&o.push(l({code:n.signature})),n.example&&o.push([a,[[t,"example",{cls:"text-xs text-text-muted uppercase tracking-wider"}],l({code:n.example})],{cls:"gap-2 my-4"}]),i({},o)},ue={home:()=>[a,[[a,[[c,[[m,[U({size:48})],{cls:"w-12 h-12 drop-shadow-[0_4px_20px_rgba(0,170,255,0.3)]"}],[a,[[t,"tooey",{cls:"text-2xl font-bold text-text-primary"}],[t,"token-efficient ui for llm output",{cls:"text-sm text-text-secondary"}]],{cls:"gap-1"}]],{cls:"gap-4 items-center flex"}],[c,[[t,"~39%",{cls:"text-accent font-semibold"}],[t,"fewer tokens",{cls:"text-text-secondary"}],[t,"|",{cls:"text-border mx-2"}],[t,"~10kb",{cls:"text-accent font-semibold"}],[t,"minified",{cls:"text-text-secondary"}],[t,"|",{cls:"text-border mx-2"}],[t,"0",{cls:"text-accent font-semibold"}],[t,"deps",{cls:"text-text-secondary"}]],{cls:"gap-1.5 items-center flex-wrap flex my-6"}]],{cls:"mb-8"}],i({},[p({title:"quick start"}),l({code:`import { render, vs, tx, bt } from '@tooey/ui';
render(document.getElementById('app'), {
  s: { count: 0 },
  r: [vs, [[tx, { $: 'count' }], [bt, '+', { c: 'count+' }]], { g: 8 }]
});`}),[c,[[S,"examples",{c:()=>te("examples"),cls:"bg-accent text-white px-4 py-2 rounded border-none cursor-pointer hover:bg-accent-hover transition-colors"}],[K,"github",{href:"https://github.com/vijaypemmaraju/tooey",cls:"text-text-secondary px-4 py-2 no-underline hover:text-accent transition-colors"}]],{cls:"gap-2 flex mt-4"}]]),[B,[i({},[[t,"signals & reactivity",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[t,"fine-grained reactivity with signals, computed, and effects",{cls:"text-text-secondary text-sm"}]]),i({},[[t,"function components",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[t,"create reusable components as simple functions",{cls:"text-text-secondary text-sm"}]]),i({},[[t,"theming",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[t,"token-based theming with $token syntax",{cls:"text-text-secondary text-sm"}]]),i({},[[t,"advanced features",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[t,"refs, context, portals, fragments, memo, router, ssr, devtools",{cls:"text-text-secondary text-sm"}]])],{cols:2,g:16,cls:"my-6"}],i({},[p({title:"components"}),[B,["layout","text","form","table","list","media"].map(e=>[a,[[t,e,{cls:"text-accent text-xs uppercase tracking-wider"}],[t,r.components.filter(n=>n.category===e).map(n=>n.name).join(" "),{cls:"text-text-primary font-mono"}]],{cls:"gap-1"}]),{cols:3,g:16}]])],{cls:"space-y-6"}],"core-functions":()=>[a,[p({title:"core functions",subtitle:"essential functions for rendering and state management"}),...r.coreFunctions.map(e=>G({item:e,type:"function"}))],{g:16}],"instance-methods":()=>[a,[p({title:"instance methods",subtitle:"methods on TooeyInstance returned by render()"}),...r.instanceMethods.map(e=>G({item:e,type:"method"}))],{g:16}],components:()=>[a,[p({title:"components",subtitle:"23 built-in components with short names"}),...["layout","text","form","table","list","media"].map(e=>i({},[[t,e,{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[B,r.components.filter(n=>n.category===e).map(n=>[a,[[c,[[t,n.name,{cls:"text-success font-bold font-mono text-base"}],[t,`(${n.fullName})`,{cls:"text-text-muted text-xs"}]],{cls:"gap-1.5 items-center flex"}],[t,n.description,{cls:"text-text-secondary text-xs"}],[t,n.element,{cls:"text-text-muted text-xs font-mono"}]],{cls:"gap-1 p-2 bg-bg-tertiary rounded"}]),{cols:2,g:8}]]))],{cls:"space-y-4"}],props:()=>[a,[p({title:"props",subtitle:"all style and element properties"}),...["spacing","sizing","colors","borders","positioning","typography","layout","misc","element"].map(e=>i({},[[t,e,{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,r.props.filter(n=>n.category===e).map(n=>[c,[[t,n.name,{cls:"text-success font-semibold font-mono text-sm w-10"}],[t,n.fullName||"",{cls:"text-text-primary text-sm w-[120px]"}],[t,n.description,{cls:"text-text-secondary text-xs flex-1"}],[t,n.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-1.5 border-b border-border"}]),{cls:"space-y-0"}]]))],{cls:"space-y-4"}],events:()=>[a,[p({title:"events & operations",subtitle:"event handlers and state operations"}),i({},[[t,"events",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,r.events.map(e=>[c,[[t,e.name,{cls:"text-success font-semibold font-mono text-sm w-10"}],[t,e.fullName||"",{cls:"text-text-primary text-sm w-[100px]"}],[t,e.description,{cls:"text-text-secondary text-xs flex-1"}],[t,e.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]]),i({},[[t,"state operations",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,r.stateOps.map(e=>[c,[[t,e.op||"",{cls:"text-warning font-bold font-mono text-base w-[30px] text-center"}],[t,e.name,{cls:"text-text-primary text-sm w-20"}],[t,e.description,{cls:"text-text-secondary text-xs flex-1"}],[t,e.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]])],{cls:"space-y-4"}],"control-flow":()=>[a,[p({title:"control flow",subtitle:"conditional rendering and list iteration"}),...r.controlFlow.map(e=>i({},[[t,e.name,{cls:"text-sm font-semibold text-text-primary block mb-2"}],[t,e.description,{cls:"text-text-secondary text-sm block mb-3"}],l({code:e.example||""})]))],{cls:"space-y-4"}],theming:()=>[a,[p({title:"theming",subtitle:"token-based theming system"}),i({},[[t,r.theming.description,{cls:"text-text-secondary block mb-4"}],[t,"interface",{cls:"text-xs text-text-muted uppercase tracking-wider"}],l({code:r.theming.interface})]),i({},[[t,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:r.theming.example})])],{cls:"space-y-4"}],plugins:()=>[a,[p({title:"plugins",subtitle:"extend with lifecycle hooks"}),i({},[[t,r.plugins.description,{cls:"text-text-secondary block mb-4"}],l({code:r.plugins.interface})]),i({},[[t,"hooks",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,r.plugins.hooks.map(e=>[c,[[t,e.name,{cls:"text-success font-semibold font-mono text-sm w-[120px]"}],[t,e.description,{cls:"text-text-secondary text-xs flex-1"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]]),i({},[[t,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:r.plugins.example})])],{cls:"space-y-4"}],"function-components":()=>[a,[p({title:"function components",subtitle:"create reusable components"}),i({},[[t,r.functionComponents.description,{cls:"text-text-secondary block mb-4"}],l({code:r.functionComponents.signature})]),i({},[[t,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:r.functionComponents.example})])],{cls:"space-y-4"}],"error-boundaries":()=>[a,[p({title:"error boundaries",subtitle:"catch render errors gracefully"}),i({},[[t,r.errorBoundaries.description,{cls:"text-text-secondary block mb-4"}],l({code:r.errorBoundaries.interface})]),i({},[[t,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:r.errorBoundaries.example})])],{cls:"space-y-4"}],types:()=>[a,[p({title:"types",subtitle:"typescript type definitions"}),...r.types.map(e=>i({},[[t,e.name,{cls:"text-success font-semibold font-mono text-sm"}],[t,e.description,{cls:"text-text-secondary text-sm my-2"}],l({code:e.signature||""})]))],{cls:"space-y-4"}],examples:()=>[a,[p({title:"examples",subtitle:"interactive demos with token comparisons"}),[a,r.examples.map(e=>i({},[[c,[[t,e.name,{cls:"text-text-primary font-semibold text-base"}],[t,e.savings,{cls:"text-success font-bold font-mono text-sm"}]],{cls:"justify-between items-center flex"}],[t,e.description,{cls:"text-text-secondary text-sm my-2 mb-4"}],[m,[[a,[[c,[[t,"tooey",{cls:"text-accent text-xs uppercase tracking-wider"}],[t,`(${e.tooeyTokens} tokens)`,{cls:"text-text-muted text-xs"}]],{cls:"gap-2 items-center flex"}],l({code:e.tooeyCode,lang:"javascript"})],{cls:"gap-2"}],[a,[[c,[[t,"react",{cls:"text-warning text-xs uppercase tracking-wider"}],[t,`(${e.reactTokens} tokens)`,{cls:"text-text-muted text-xs"}]],{cls:"gap-2 items-center flex"}],l({code:e.reactCode,lang:"jsx"})],{cls:"gap-2"}]],{cls:"grid grid-cols-1 sm:grid-cols-2 gap-4"}],[t,"live demos",{cls:"text-text-muted text-xs uppercase tracking-wider mt-4 mb-2"}],[m,[[a,[[t,"tooey",{cls:"text-accent text-[10px] uppercase tracking-wider"}],[m,"",{id:`demo-tooey-${e.id}`,cls:"bg-bg-tertiary p-4 rounded-lg border border-border min-h-[100px]"}]],{cls:"gap-2"}],[a,[[t,"react",{cls:"text-warning text-[10px] uppercase tracking-wider"}],[m,"",{id:`demo-react-${e.id}`,cls:"bg-bg-tertiary p-4 rounded-lg border border-border min-h-[100px]"}]],{cls:"gap-2"}]],{cls:"grid grid-cols-1 sm:grid-cols-2 gap-4"}]])),{cls:"space-y-6"}]],{cls:"space-y-4"}],"advanced-features":()=>[a,[p({title:"advanced features",subtitle:"refs, context, portals, fragments, reducer, memo, ssr, router, devtools"}),i({},[[c,[[t,"refs",{cls:"text-accent text-xs uppercase"}],[t,"ref()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"access dom elements directly for focus, measurements, or third-party integration",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const inputRef = ref();
render(el, { r: [vs, [
  [In, '', { rf: inputRef, ph: 'type here...' }],
  [bt, 'focus', { c: () => inputRef.el?.focus() }]
]] });`})]),i({},[[c,[[t,"context",{cls:"text-accent text-xs uppercase"}],[t,"cx() ux()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"pass data deeply without prop drilling",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const ThemeCtx = cx('#007bff');
const Themed = () => [tx, 'text', { fg: ux(ThemeCtx) }];
render(el, { r: { pv: ThemeCtx, v: '#ff0000', c: [Themed] } });`})]),i({},[[c,[[t,"portals",{cls:"text-accent text-xs uppercase"}],[t,"{ pt: target, c: [...] }",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"render content outside the normal dom tree (modals, tooltips)",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`// render modal to document.body
{ pt: document.body, c: [dv, [[tx, 'modal']], { pos: 'fix' }] }`})]),i({},[[c,[[t,"fragments",{cls:"text-accent text-xs uppercase"}],[t,"fr",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"group children without a visible wrapper (uses display: contents)",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:"[fr, [[tx, 'one'], [tx, 'two'], [tx, 'three']]]"})]),i({},[[c,[[t,"reducer",{cls:"text-accent text-xs uppercase"}],[t,"rd$()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"complex state logic with reducer pattern (like useReducer)",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const reducer = (s, a) => a.type === 'inc' ? { n: s.n + 1 } : s;
const { s, dp } = rd$(reducer, { n: 0 });
render(el, { s, r: [vs, [[tx, { $: 'n' }], [bt, '+', { c: () => dp({ type: 'inc' }) }]]] });`})]),i({},[[c,[[t,"memo",{cls:"text-accent text-xs uppercase"}],[t,"mm()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"memoize expensive components to prevent unnecessary re-renders",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const ExpensiveList = mm((props) => [vs, props.items.map(i => [tx, i])]);
// or declarative: { mm: ['dep1', 'dep2'], c: [...] }`})]),i({},[[c,[[t,"ssr",{cls:"text-accent text-xs uppercase"}],[t,"rts() hy()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"server-side rendering and hydration",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`// server
const html = rts({ s: { name: 'world' }, r: [tx, { $: 'name' }] });
// client
const app = hy(container, spec);`})]),i({},[[c,[[t,"router",{cls:"text-accent text-xs uppercase"}],[t,"lk ot() nav()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"client-side routing for single-page apps",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const routes = [{ p: '/', c: Home }, { p: '/about', c: About }];
[vs, [[lk, 'home', { to: '/' }], [lk, 'about', { to: '/about' }], ot(routes)]]`})]),i({},[[c,[[t,"devtools",{cls:"text-accent text-xs uppercase"}],[t,"devtools()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[t,"debugging plugin with state inspection and history (this docs site uses it!)",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`render(el, spec, { plugins: [devtools({ name: 'my-app' })] });
// console: window.__TOOEY_DEVTOOLS__.getState()`})])],{cls:"space-y-4"}]},q={},H={};r.examples.forEach(e=>{q[e.id]=e.demoSpec,H[e.id]=e.reactDemoCode});var v=[{label:"home",page:"home"},{label:"core functions",page:"core-functions"},{label:"instance methods",page:"instance-methods"},{label:"components",page:"components"},{label:"props",page:"props"},{label:"events & ops",page:"events"},{label:"control flow",page:"control-flow"},{label:"theming",page:"theming"},{label:"plugins",page:"plugins"},{label:"function components",page:"function-components"},{label:"error boundaries",page:"error-boundaries"},{label:"advanced features",page:"advanced-features"},{label:"types",page:"types"},{label:"examples",page:"examples"}],z=I(window.location.hash.slice(1)||"home"),P=I(""),k=I([]),x=I(window.matchMedia("(prefers-color-scheme: dark)").matches),N,h,te=e=>{window.location.hash=e,z.set(e),P.set(""),k.set([])},J=!1,C=null,ne=e=>{C||(C=document.createElement("style"),document.head.appendChild(C)),C.textContent=e?`
  ...
  `},ge=()=>J?Promise.resolve():new Promise(e=>{ne(x());let n=document.createElement("script");n.src="https://unpkg.com/prismjs@1/prism.min.js",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/prismjs@1/components/prism-jsx.min.js",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/prismjs@1/components/prism-typescript.min.js",o.onload=()=>{J=!0,e()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),xe=()=>{let e=window.Prism;e&&document.querySelectorAll('code[class*="language-"]').forEach(n=>{n.classList.contains("prism-highlighted")||(e.highlightElement(n),n.classList.add("prism-highlighted"))})},Y=!1,fe=()=>Y?Promise.resolve():new Promise(e=>{let n=document.createElement("script");n.src="https://unpkg.com/react@18/umd/react.development.js",n.crossOrigin="anonymous",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/react-dom@18/umd/react-dom.development.js",s.crossOrigin="anonymous",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/@babel/standalone/babel.min.js",o.onload=()=>{Y=!0,e()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),ye=(e,n)=>{try{let s=window.Babel,o=window.React,f=window.ReactDOM;if(!s||!o||!f)return;let L=s.transform(n,{presets:["react"]}).code,u=new Function("React",`${L}; return ${n.match(/function\s+(\w+)/)?.[1]||"Component"};`)(o);f.createRoot(e).render(o.createElement(u)),e.dataset.rendered="true"}catch(s){console.warn("[tooey] failed to render react demo:",s),e.textContent="failed to render"}},be=()=>{if(!N)return;let e=z();N.innerHTML="",$(N,{r:ue[e]()}),ee(),requestAnimationFrame(()=>{me(),ge().then(()=>{requestAnimationFrame(xe)})}),document.querySelectorAll(".nav-btn").forEach((n,s)=>{let o=n;o.style.background=v[s].page===e?"var(--bg-tertiary)":"transparent",o.style.color=v[s].page===e?"var(--accent)":"var(--text-secondary)"}),e==="examples"&&(Object.keys(q).forEach(n=>{let s=document.getElementById(`demo-tooey-${n}`);if(s&&!s.dataset.rendered)try{let o=JSON.parse(q[n]);$(s,o),s.dataset.rendered="true"}catch(o){console.warn("[tooey] failed to render demo:",n,o)}}),fe().then(()=>{Object.keys(H).forEach(n=>{let s=document.getElementById(`demo-react-${n}`);s&&!s.dataset.rendered&&ye(s,H[n])})}))},T=()=>{if(!h)return;let e=k();if(!e.length){h.innerHTML="";return}h.innerHTML="",$(h,{r:[a,e.slice(0,10).map(n=>[m,[[c,[[t,n.type,{cls:"text-[9px] text-accent bg-bg-tertiary px-1.5 py-0.5 rounded uppercase"}],[t,n.name,{cls:"text-text-primary font-medium text-sm"}]],{cls:"gap-1.5 items-center flex"}],[t,n.description,{cls:"text-text-secondary text-xs"}]],{cls:"search-result p-2 rounded cursor-pointer hover:bg-bg-tertiary transition-colors"}]),{cls:"absolute top-[42px] left-0 right-0 bg-bg-secondary rounded p-2 z-[100] max-h-[300px] overflow-auto border border-border shadow-lg"}]})},Z=ie(),he=()=>{X(x()?E:Q),le();let e=document.getElementById("app");if(!e)return;let n=ce({name:"tooey-docs",log:!1}),s={s:{},r:[c,[[S,"",{id:"menu-btn",cls:"fixed top-4 left-4 z-[1001] bg-bg-secondary p-2.5 rounded-lg border border-border hidden"}],[m,"",{id:"sidebar-overlay",cls:"fixed inset-0 z-[999] bg-black/50 hidden"}],[a,[[c,[U({size:32}),[t,"tooey",{cls:"text-lg font-bold text-text-primary"}]],{cls:"gap-2 items-center flex mb-6"}],[a,[[re,"",{ph:"search...",id:"search",rf:Z,cls:"bg-bg-tertiary text-text-primary px-3 py-2 rounded w-full border border-border outline-none focus:border-accent"}],[m,"",{id:"search-results"}]],{cls:"relative mb-4"}],[a,v.map(d=>[S,d.label,{cls:"nav-btn bg-transparent text-text-secondary px-3 py-2 rounded w-full text-left text-sm cursor-pointer border-none hover:bg-bg-tertiary hover:text-accent transition-colors"}]),{cls:"gap-0.5"}],[c,[[S,"",{id:"theme-btn",cls:"bg-transparent text-text-secondary p-2 rounded cursor-pointer border-none hover:text-accent transition-colors"}],[K,"",{href:"https://github.com/vijaypemmaraju/tooey",id:"github-link",cls:"text-text-secondary p-2 hover:text-accent transition-colors"}]],{cls:"gap-2 mt-auto"}]],{id:"sidebar",cls:"w-60 h-screen p-6 bg-bg-secondary fixed top-0 left-0 z-[1000] border-r border-border overflow-y-auto flex flex-col transition-transform duration-300"}],[m,[{boundary:!0,child:[m,"",{id:"page-content"}],fallback:i({},[[t,"error",{cls:"text-error font-semibold"}]]),onError:d=>console.error(d)}],{id:"main-content",cls:"ml-60 p-8 max-w-[900px] min-h-screen"}]],{cls:"w-full"}]};$(e,s,{plugins:[de,n]}),N=document.getElementById("page-content"),h=document.getElementById("search-results");let o=Z.el,f=document.getElementById("theme-btn"),L=document.getElementById("github-link"),u=document.getElementById("menu-btn"),R=document.getElementById("sidebar"),j=document.getElementById("sidebar-overlay"),b=document.getElementById("main-content"),A='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>',O='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>',oe='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.386-1.332-1.755-1.332-1.755-1.089-.744.083-.729.083-.729 1.205.085 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.605-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 21.795 24 17.295 24 12c0-6.63-5.37-12-12-12z"/></svg>',M='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12h18M3 6h18M3 18h18"/></svg>',se='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6L6 18M6 6l12 12"/></svg>';f.innerHTML=x()?A:O,L.innerHTML=oe,u.innerHTML=M;let F=window.innerWidth<=768,g=!1,w=()=>{F=window.innerWidth<=768,F?(u.style.display="block",R.style.transform=g?"translateX(0)":"translateX(-100%)",j.style.display=g?"block":"none",b.style.marginLeft="0",b.style.padding="16px",b.style.paddingTop="60px"):(u.style.display="none",R.style.transform="translateX(0)",j.style.display="none",b.style.marginLeft="240px",b.style.padding="32px",g=!1)},ae=()=>{g=!g,u.innerHTML=g?se:M,w()},V=()=>{g&&(g=!1,u.innerHTML=M,w())};u.addEventListener("click",ae),j.addEventListener("click",V),window.addEventListener("resize",w),w(),o?.addEventListener("input",d=>{let y=d.target.value;P.set(y),k.set(W(y)),T()}),o?.addEventListener("keydown",d=>{d.key==="Escape"&&(P.set(""),k.set([]),o.value="",T())}),document.addEventListener("click",d=>{!d.target.closest("#search")&&!d.target.closest("#search-results")&&(k.set([]),T())}),document.querySelectorAll(".nav-btn").forEach((d,y)=>{d.addEventListener("click",()=>{te(v[y].page),V()})}),f.addEventListener("click",()=>{x.set(!x()),X(x()?E:Q),f.innerHTML=x()?A:O,ne(x())}),window.addEventListener("popstate",()=>{let d=window.location.hash.slice(1)||"home";v.some(y=>y.page===d)&&z.set(d)}),_(be),_(T),ee()};document.addEventListener("DOMContentLoaded",he);
