...
[Card, [[T, 'Hello']], { bg: '#f0f0f0' }]`},errorBoundaries:{description:"catch render errors and show fallback ui",interface:`interface ErrorBoundaryNode {
  ...
  `,document.head.appendChild(t)},be={name:"logger",onStateChange(t,n,s){["searchQuery","searchResults"].includes(t)||console.log(`[docs] ${t}:`,n,"\u2192",s)}},re=t=>{let n=t.size||32;return[m,"",{w:n,h:n,s:{display:"inline-block"},id:`logo-${Math.random().toString(36).slice(2,8)}`}]},ie=()=>{document.querySelectorAll('[id^="logo-"]').forEach(t=>{if(t.innerHTML)return;let n=parseInt(t.style.width)||32;t.innerHTML=`<svg width="${n}" height="${n}" viewBox="0 0 64 64" style="color: var(--accent);">
    ...
    </svg>`})},r=(t={},n=[])=>[a,n,{cls:"bg-bg-secondary p-4 rounded-lg border border-border"}],z=new Map,l=t=>{let n=`code-${Math.random().toString(36).slice(2,8)}`;return z.set(n,{code:t.code,lang:t.lang||"javascript"}),[m,"",{id:n,cls:"bg-code-bg rounded overflow-auto max-h-[300px]"}]},he=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ve=()=>{z.forEach(({code:t,lang:n},s)=>{let o=document.getElementById(s);o&&!o.querySelector("pre")&&(o.innerHTML=`<pre style="margin:0;padding:8px;font-size:12px;line-height:1.4;"><code class="language-${n}">${he(t)}</code></pre>`)}),z.clear()},d=t=>[a,[[e,t.title,{cls:"text-xs font-normal text-text-muted uppercase tracking-wider block"}],t.subtitle?[e,t.subtitle,{cls:"text-sm text-text-secondary mt-1"}]:null].filter(Boolean),{cls:"mb-4"}],te=t=>{let{item:n,type:s}=t,o=[[i,[[e,s,{cls:"text-[10px] text-accent bg-bg-tertiary px-2 py-0.5 rounded uppercase"}],[e,n.name||n.op||n.fullName||"",{cls:"text-lg font-semibold text-text-primary"}]],{cls:"gap-2 items-center flex"}],[e,n.description,{cls:"text-text-secondary my-2 mb-4 block"}]];return n.signature&&o.push(l({code:n.signature})),n.example&&o.push([a,[[e,"example",{cls:"text-xs text-text-muted uppercase tracking-wider"}],l({code:n.example})],{cls:"gap-2 my-4"}]),r({},o)},ke={home:()=>[a,[[a,[[i,[[m,[re({size:48})],{cls:"w-12 h-12 drop-shadow-[0_4px_20px_rgba(0,170,255,0.3)]"}],[a,[[e,"tooey",{cls:"text-2xl font-bold text-text-primary"}],[e,"token-efficient ui for llm output",{cls:"text-sm text-text-secondary"}]],{cls:"gap-1"}]],{cls:"gap-4 items-center flex"}],[i,[[e,"~39%",{cls:"text-accent font-semibold"}],[e,"fewer tokens",{cls:"text-text-secondary"}],[e,"|",{cls:"text-border mx-2"}],[e,"~10kb",{cls:"text-accent font-semibold"}],[e,"minified",{cls:"text-text-secondary"}],[e,"|",{cls:"text-border mx-2"}],[e,"0",{cls:"text-accent font-semibold"}],[e,"deps",{cls:"text-text-secondary"}]],{cls:"gap-1.5 items-center flex-wrap flex my-6"}]],{cls:"mb-8"}],r({},[d({title:"quick start"}),l({code:`import { render, vs, tx, bt } from '@tooey/ui';
render(document.getElementById('app'), {
  s: { count: 0 },
  r: [vs, [[tx, { $: 'count' }], [bt, '+', { c: 'count+' }]], { g: 8 }]
});`}),[i,[[E,"examples",{c:()=>ce("examples"),cls:"bg-accent text-white px-4 py-2 rounded border-none cursor-pointer hover:bg-accent-hover transition-colors"}],[ae,"github",{href:"https://github.com/vijaypemmaraju/tooey",cls:"text-text-secondary px-4 py-2 no-underline hover:text-accent transition-colors"}]],{cls:"gap-2 flex mt-4"}]]),[S,[r({},[[e,"signals & reactivity",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[e,"fine-grained reactivity with signals, computed, and effects",{cls:"text-text-secondary text-sm"}]]),r({},[[e,"function components",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[e,"create reusable components as simple functions",{cls:"text-text-secondary text-sm"}]]),r({},[[e,"theming",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[e,"token-based theming with $token syntax",{cls:"text-text-secondary text-sm"}]]),r({},[[e,"advanced features",{cls:"font-semibold text-text-primary text-sm block mb-2"}],[e,"refs, context, portals, fragments, memo, router, ssr, devtools",{cls:"text-text-secondary text-sm"}]])],{cols:2,g:16,cls:"my-6"}],r({},[d({title:"components"}),[S,["layout","text","form","table","list","media"].map(t=>[a,[[e,t,{cls:"text-accent text-xs uppercase tracking-wider"}],[e,c.components.filter(n=>n.category===t).map(n=>n.name).join(" "),{cls:"text-text-primary font-mono"}]],{cls:"gap-1"}]),{cols:3,g:16}]])],{cls:"space-y-6"}],"core-functions":()=>[a,[d({title:"core functions",subtitle:"essential functions for rendering and state management"}),...c.coreFunctions.map(t=>te({item:t,type:"function"}))],{g:16}],"instance-methods":()=>[a,[d({title:"instance methods",subtitle:"methods on TooeyInstance returned by render()"}),...c.instanceMethods.map(t=>te({item:t,type:"method"}))],{g:16}],components:()=>[a,[d({title:"components",subtitle:"23 built-in components with short names"}),...["layout","text","form","table","list","media"].map(t=>r({},[[e,t,{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[S,c.components.filter(n=>n.category===t).map(n=>[a,[[i,[[e,n.name,{cls:"text-success font-bold font-mono text-base"}],[e,`(${n.fullName})`,{cls:"text-text-muted text-xs"}]],{cls:"gap-1.5 items-center flex"}],[e,n.description,{cls:"text-text-secondary text-xs"}],[e,n.element,{cls:"text-text-muted text-xs font-mono"}]],{cls:"gap-1 p-2 bg-bg-tertiary rounded"}]),{cols:2,g:8}]]))],{cls:"space-y-4"}],props:()=>[a,[d({title:"props",subtitle:"all style and element properties"}),...["spacing","sizing","colors","borders","positioning","typography","layout","misc","element"].map(t=>r({},[[e,t,{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,c.props.filter(n=>n.category===t).map(n=>[i,[[e,n.name,{cls:"text-success font-semibold font-mono text-sm w-10"}],[e,n.fullName||"",{cls:"text-text-primary text-sm w-[120px]"}],[e,n.description,{cls:"text-text-secondary text-xs flex-1"}],[e,n.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-1.5 border-b border-border"}]),{cls:"space-y-0"}]]))],{cls:"space-y-4"}],events:()=>[a,[d({title:"events & operations",subtitle:"event handlers and state operations"}),r({},[[e,"events",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,c.events.map(t=>[i,[[e,t.name,{cls:"text-success font-semibold font-mono text-sm w-10"}],[e,t.fullName||"",{cls:"text-text-primary text-sm w-[100px]"}],[e,t.description,{cls:"text-text-secondary text-xs flex-1"}],[e,t.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]]),r({},[[e,"state operations",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,c.stateOps.map(t=>[i,[[e,t.op||"",{cls:"text-warning font-bold font-mono text-base w-[30px] text-center"}],[e,t.name,{cls:"text-text-primary text-sm w-20"}],[e,t.description,{cls:"text-text-secondary text-xs flex-1"}],[e,t.example||"",{cls:"text-text-muted font-mono text-xs"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]])],{cls:"space-y-4"}],"control-flow":()=>[a,[d({title:"control flow",subtitle:"conditional rendering and list iteration"}),...c.controlFlow.map(t=>r({},[[e,t.name,{cls:"text-sm font-semibold text-text-primary block mb-2"}],[e,t.description,{cls:"text-text-secondary text-sm block mb-3"}],l({code:t.example||""})]))],{cls:"space-y-4"}],theming:()=>[a,[d({title:"theming",subtitle:"token-based theming system"}),r({},[[e,c.theming.description,{cls:"text-text-secondary block mb-4"}],[e,"interface",{cls:"text-xs text-text-muted uppercase tracking-wider"}],l({code:c.theming.interface})]),r({},[[e,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:c.theming.example})])],{cls:"space-y-4"}],plugins:()=>[a,[d({title:"plugins",subtitle:"extend with lifecycle hooks"}),r({},[[e,c.plugins.description,{cls:"text-text-secondary block mb-4"}],l({code:c.plugins.interface})]),r({},[[e,"hooks",{cls:"text-sm font-semibold text-accent uppercase mb-3 block"}],[a,c.plugins.hooks.map(t=>[i,[[e,t.name,{cls:"text-success font-semibold font-mono text-sm w-[120px]"}],[e,t.description,{cls:"text-text-secondary text-xs flex-1"}]],{cls:"gap-2 items-center flex py-2 border-b border-border"}]),{cls:"space-y-0"}]]),r({},[[e,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:c.plugins.example})])],{cls:"space-y-4"}],"function-components":()=>[a,[d({title:"function components",subtitle:"create reusable components"}),r({},[[e,c.functionComponents.description,{cls:"text-text-secondary block mb-4"}],l({code:c.functionComponents.signature})]),r({},[[e,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:c.functionComponents.example})])],{cls:"space-y-4"}],"error-boundaries":()=>[a,[d({title:"error boundaries",subtitle:"catch render errors gracefully"}),r({},[[e,c.errorBoundaries.description,{cls:"text-text-secondary block mb-4"}],l({code:c.errorBoundaries.interface})]),r({},[[e,"example",{cls:"text-xs text-text-muted uppercase tracking-wider mb-2 block"}],l({code:c.errorBoundaries.example})])],{cls:"space-y-4"}],types:()=>[a,[d({title:"types",subtitle:"typescript type definitions"}),...c.types.map(t=>r({},[[e,t.name,{cls:"text-success font-semibold font-mono text-sm"}],[e,t.description,{cls:"text-text-secondary text-sm my-2"}],l({code:t.signature||""})]))],{cls:"space-y-4"}],examples:()=>[a,[d({title:"examples",subtitle:"interactive demos with token comparisons"}),[a,c.examples.map(t=>r({},[[i,[[e,t.name,{cls:"text-text-primary font-semibold text-base"}],[e,t.savings,{cls:"text-success font-bold font-mono text-sm"}]],{cls:"justify-between items-center flex"}],[e,t.description,{cls:"text-text-secondary text-sm my-2 mb-4"}],[m,[[a,[[i,[[e,"tooey",{cls:"text-accent text-xs uppercase tracking-wider"}],[e,`(${t.tooeyTokens} tokens)`,{cls:"text-text-muted text-xs"}]],{cls:"gap-2 items-center flex"}],l({code:t.tooeyCode,lang:"javascript"})],{cls:"gap-2"}],[a,[[i,[[e,"react",{cls:"text-warning text-xs uppercase tracking-wider"}],[e,`(${t.reactTokens} tokens)`,{cls:"text-text-muted text-xs"}]],{cls:"gap-2 items-center flex"}],l({code:t.reactCode,lang:"jsx"})],{cls:"gap-2"}]],{cls:"grid grid-cols-1 sm:grid-cols-2 gap-4"}],[e,"live demos",{cls:"text-text-muted text-xs uppercase tracking-wider mt-4 mb-2"}],[m,[[a,[[e,"tooey",{cls:"text-accent text-[10px] uppercase tracking-wider"}],[m,"",{id:`demo-tooey-${t.id}`,cls:"bg-bg-tertiary p-4 rounded-lg border border-border min-h-[100px]"}]],{cls:"gap-2"}],[a,[[e,"react",{cls:"text-warning text-[10px] uppercase tracking-wider"}],[m,"",{id:`demo-react-${t.id}`,cls:"bg-bg-tertiary p-4 rounded-lg border border-border min-h-[100px]"}]],{cls:"gap-2"}]],{cls:"grid grid-cols-1 sm:grid-cols-2 gap-4"}]])),{cls:"space-y-6"}]],{cls:"space-y-4"}],"advanced-features":()=>[a,[d({title:"advanced features",subtitle:"refs, context, portals, fragments, reducer, memo, ssr, router, devtools"}),r({},[[i,[[e,"refs",{cls:"text-accent text-xs uppercase"}],[e,"ref()",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"access dom elements directly for focus, measurements, or third-party integration",{cls:"text-text-secondary text-sm mb-3 block"}],l({code:`const inputRef = ref();
render(el, { r: [vs, [
...
// console: window.__TOOEY_DEVTOOLS__.getState()`})])],{cls:"space-y-4"}],"component-library":()=>[a,[d({title:"@tooey/components",subtitle:"shadcn-inspired component library for tooey"}),r({},[[e,"a collection of pre-built, beautifully designed components inspired by shadcn/ui. includes buttons, cards, badges, alerts, progress bars, and more - all optimized for token efficiency.",{cls:"text-text-secondary text-sm block mb-4"}],[i,[[f,[[e,"beta"]],{variant:"secondary"}],[f,[[e,"~10kb"]],{variant:"outline"}],[f,[[e,"token-efficient"]],{}]],{cls:"gap-2 flex flex-wrap"}]]),r({},[[i,[[e,"buttons",{cls:"text-accent text-xs uppercase"}],[e,"Bt",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"6 variants (default, destructive, outline, secondary, ghost, link) and 4 sizes",{cls:"text-text-secondary text-sm mb-3 block"}],[i,[[h,"",{label:"default"}],[h,"",{label:"destructive",variant:"destructive"}],[h,"",{label:"outline",variant:"outline"}],[h,"",{label:"secondary",variant:"secondary"}],[h,"",{label:"ghost",variant:"ghost"}],[h,"",{label:"link",variant:"link"}]],{cls:"gap-2 flex flex-wrap"}],l({code:"[Bt, '', { label: 'click me', variant: 'outline' }]"})]),r({},[[i,[[e,"badges",{cls:"text-accent text-xs uppercase"}],[e,"Bg",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"4 variants for labels, tags, and status indicators",{cls:"text-text-secondary text-sm mb-3 block"}],[i,[[f,"",{label:"default"}],[f,"",{label:"secondary",variant:"secondary"}],[f,"",{label:"destructive",variant:"destructive"}],[f,"",{label:"outline",variant:"outline"}]],{cls:"gap-2 flex flex-wrap"}],l({code:"[Bg, '', { label: 'new', variant: 'secondary' }]"})]),r({},[[i,[[e,"alerts",{cls:"text-accent text-xs uppercase"}],[e,"Al AlT AlD",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"notification messages with title and description",{cls:"text-text-secondary text-sm mb-3 block"}],[Y,[[Z,[[e,"heads up!"]]],[K,[[e,"you can use these components to build beautiful uis"]]]]],[m,"",{h:8}],[Y,[[Z,[[e,"error"]]],[K,[[e,"something went wrong"]]]],{variant:"destructive"}],l({code:"[Al, [[AlT, [[tx, 'title']]], [AlD, [[tx, 'description']]]], { variant: 'destructive' }]"})]),r({},[[i,[[e,"progress",{cls:"text-accent text-xs uppercase"}],[e,"Pg",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"progress bar with customizable value and max",{cls:"text-text-secondary text-sm mb-3 block"}],[a,[[q,"",{value:25}],[q,"",{value:50}],[q,"",{value:75}]],{cls:"gap-2"}],l({code:"[Pg, '', { value: 75, max: 100 }]"})]),r({},[[i,[[e,"avatar",{cls:"text-accent text-xs uppercase"}],[e,"Av",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"user avatar with image support and fallback initials",{cls:"text-text-secondary text-sm mb-3 block"}],[i,[[P,"",{fallback:"JD"}],[P,"",{fallback:"AB",w:48}],[P,"",{fallback:"?",w:32}]],{cls:"gap-2 items-center flex"}],l({code:"[Av, '', { fallback: 'JD', w: 48 }]"})]),r({},[[i,[[e,"separator",{cls:"text-accent text-xs uppercase"}],[e,"Sp",{cls:"text-success font-mono text-sm"}]],{cls:"gap-2 items-center flex mb-2"}],[e,"divider line - horizontal or vertical",{cls:"text-text-secondary text-sm mb-3 block"}],[a,[[e,"content above",{cls:"text-text-secondary text-sm"}],[fe],[e,"content below",{cls:"text-text-secondary text-sm"}]],{cls:"gap-2"}],l({code:"[Sp]  // or [Sp, '', { orientation: 'vertical' }]"})]),r({},[[e,"all available components",{cls:"text-accent text-xs uppercase mb-2 block"}],[S,[[a,[[e,"layout",{cls:"text-success text-xs uppercase"}],[e,"Cd CdH CdT CdD CdC CdF",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}],[a,[[e,"form",{cls:"text-success text-xs uppercase"}],[e,"Ip Ta Sl Cb Rg RgI Lb Sw",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}],[a,[[e,"feedback",{cls:"text-success text-xs uppercase"}],[e,"Al AlT AlD Bg Pg Sk",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}],[a,[[e,"overlay",{cls:"text-success text-xs uppercase"}],[e,"Dg DgO DgC DgH DgT DgD DgF",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}],[a,[[e,"navigation",{cls:"text-success text-xs uppercase"}],[e,"Tb TbL TbT TbC Ac AcI AcT AcC",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}],[a,[[e,"misc",{cls:"text-success text-xs uppercase"}],[e,"Av Sp Tt Dd DdT DdM DdI",{cls:"text-text-primary font-mono text-sm"}]],{cls:"gap-1"}]],{cols:3,g:16}]]),r({},[[e,"installation",{cls:"text-accent text-xs uppercase mb-2 block"}],l({code:`npm install @tooey/components
...
tooey.render(el, { r: [Bt, '', { label: 'hello' }] });`})])],{cls:"space-y-4"}]},H={},O={};c.examples.forEach(t=>{H[t.id]=t.demoSpec,O[t.id]=t.reactDemoCode});var w=[{label:"home",page:"home"},{label:"core functions",page:"core-functions"},{label:"instance methods",page:"instance-methods"},{label:"components",page:"components"},{label:"props",page:"props"},{label:"events & ops",page:"events"},{label:"control flow",page:"control-flow"},{label:"theming",page:"theming"},{label:"plugins",page:"plugins"},{label:"function components",page:"function-components"},{label:"error boundaries",page:"error-boundaries"},{label:"advanced features",page:"advanced-features"},{label:"types",page:"types"},{label:"examples",page:"examples"},{label:"@tooey/components",page:"component-library"}],V=R(window.location.hash.slice(1)||"home"),F=R(""),C=R([]),x=R(window.matchMedia("(prefers-color-scheme: dark)").matches),I,k,ce=t=>{window.location.hash=t,V.set(t),F.set(""),C.set([])},ne=!1,N=null,le=t=>{N||(N=document.createElement("style"),document.head.appendChild(N)),N.textContent=t?`
  ...
  `},we=()=>ne?Promise.resolve():new Promise(t=>{le(x());let n=document.createElement("script");n.src="https://unpkg.com/prismjs@1/prism.min.js",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/prismjs@1/components/prism-jsx.min.js",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/prismjs@1/components/prism-typescript.min.js",o.onload=()=>{ne=!0,t()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),Ce=()=>{let t=window.Prism;t&&document.querySelectorAll('code[class*="language-"]').forEach(n=>{n.classList.contains("prism-highlighted")||(t.highlightElement(n),n.classList.add("prism-highlighted"))})},oe=!1,Te=()=>oe?Promise.resolve():new Promise(t=>{let n=document.createElement("script");n.src="https://unpkg.com/react@18/umd/react.development.js",n.crossOrigin="anonymous",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/react-dom@18/umd/react-dom.development.js",s.crossOrigin="anonymous",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/@babel/standalone/babel.min.js",o.onload=()=>{oe=!0,t()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),Se=(t,n)=>{try{let s=window.Babel,o=window.React,y=window.ReactDOM;if(!s||!o||!y)return;let B=s.transform(n,{presets:["react"]}).code,u=new Function("React",`${B}; return ${n.match(/function\s+(\w+)/)?.[1]||"Component"};`)(o);y.createRoot(t).render(o.createElement(u)),t.dataset.rendered="true"}catch(s){console.warn("[tooey] failed to render react demo:",s),t.textContent="failed to render"}},Ne=()=>{if(!I)return;let t=V();I.innerHTML="",L(I,{r:ke[t]()}),ie(),requestAnimationFrame(()=>{ve(),we().then(()=>{requestAnimationFrame(Ce)})}),document.querySelectorAll(".nav-btn").forEach((n,s)=>{let o=n;o.style.background=w[s].page===t?"var(--bg-tertiary)":"transparent",o.style.color=w[s].page===t?"var(--accent)":"var(--text-secondary)"}),t==="examples"&&(Object.keys(H).forEach(n=>{let s=document.getElementById(`demo-tooey-${n}`);if(s&&!s.dataset.rendered)try{let o=JSON.parse(H[n]);L(s,o),s.dataset.rendered="true"}catch(o){console.warn("[tooey] failed to render demo:",n,o)}}),Te().then(()=>{Object.keys(O).forEach(n=>{let s=document.getElementById(`demo-react-${n}`);s&&!s.dataset.rendered&&Se(s,O[n])})}))},$=()=>{if(!k)return;let t=C();if(!t.length){k.innerHTML="";return}k.innerHTML="",L(k,{r:[a,t.slice(0,10).map(n=>[m,[[i,[[e,n.type,{cls:"text-[9px] text-accent bg-bg-tertiary px-1.5 py-0.5 rounded uppercase"}],[e,n.name,{cls:"text-text-primary font-medium text-sm"}]],{cls:"gap-1.5 items-center flex"}],[e,n.description,{cls:"text-text-secondary text-xs"}]],{cls:"search-result p-2 rounded cursor-pointer hover:bg-bg-tertiary transition-colors"}]),{cls:"absolute top-[42px] left-0 right-0 bg-bg-secondary rounded p-2 z-[100] max-h-[300px] overflow-auto border border-border shadow-lg"}]})},se=ge(),$e=()=>{ee(x()?D:U),ye();let t=document.getElementById("app");if(!t)return;let n=xe({name:"tooey-docs",log:!1}),s={s:{},r:[i,[[E,"",{id:"menu-btn",cls:"fixed top-4 left-4 z-[1001] bg-bg-secondary p-2.5 rounded-lg border border-border hidden"}],[m,"",{id:"sidebar-overlay",cls:"fixed inset-0 z-[999] bg-black/50 hidden"}],[a,[[i,[re({size:32}),[e,"tooey",{cls:"text-lg font-bold text-text-primary"}]],{cls:"gap-2 items-center flex mb-6"}],[a,[[ue,"",{ph:"search...",id:"search",rf:se,cls:"bg-bg-tertiary text-text-primary px-3 py-2 rounded w-full border border-border outline-none focus:border-accent"}],[m,"",{id:"search-results"}]],{cls:"relative mb-4"}],[a,w.map(p=>[E,p.label,{cls:"nav-btn bg-transparent text-text-secondary px-3 py-2 rounded w-full text-left text-sm cursor-pointer border-none hover:bg-bg-tertiary hover:text-accent transition-colors"}]),{cls:"gap-0.5"}],[i,[[E,"",{id:"theme-btn",cls:"bg-transparent text-text-secondary p-2 rounded cursor-pointer border-none hover:text-accent transition-colors"}],[ae,"",{href:"https://github.com/vijaypemmaraju/tooey",id:"github-link",cls:"text-text-secondary p-2 hover:text-accent transition-colors"}]],{cls:"gap-2 mt-auto"}]],{id:"sidebar",cls:"w-60 h-screen p-6 bg-bg-secondary fixed top-0 left-0 z-[1000] border-r border-border overflow-y-auto flex flex-col transition-transform duration-300"}],[m,[{boundary:!0,child:[m,"",{id:"page-content"}],fallback:r({},[[e,"error",{cls:"text-error font-semibold"}]]),onError:p=>console.error(p)}],{id:"main-content",cls:"ml-60 p-8 max-w-[900px] min-h-screen"}]],{cls:"w-full"}]};L(t,s,{plugins:[be,n]}),I=document.getElementById("page-content"),k=document.getElementById("search-results");let o=se.el,y=document.getElementById("theme-btn"),B=document.getElementById("github-link"),u=document.getElementById("menu-btn"),j=document.getElementById("sidebar"),M=document.getElementById("sidebar-overlay"),v=document.getElementById("main-content"),W='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>',_='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>',de='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.386-1.332-1.755-1.332-1.755-1.089-.744.083-.729.083-.729 1.205.085 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.605-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 21.795 24 17.295 24 12c0-6.63-5.37-12-12-12z"/></svg>',A='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12h18M3 6h18M3 18h18"/></svg>',pe='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6L6 18M6 6l12 12"/></svg>';y.innerHTML=x()?W:_,B.innerHTML=de,u.innerHTML=A;let Q=window.innerWidth<=768,g=!1,T=()=>{Q=window.innerWidth<=768,Q?(u.style.display="block",j.style.transform=g?"translateX(0)":"translateX(-100%)",M.style.display=g?"block":"none",v.style.marginLeft="0",v.style.padding="16px",v.style.paddingTop="60px"):(u.style.display="none",j.style.transform="translateX(0)",M.style.display="none",v.style.marginLeft="240px",v.style.padding="32px",g=!1)},me=()=>{g=!g,u.innerHTML=g?pe:A,T()},X=()=>{g&&(g=!1,u.innerHTML=A,T())};u.addEventListener("click",me),M.addEventListener("click",X),window.addEventListener("resize",T),T(),o?.addEventListener("input",p=>{let b=p.target.value;F.set(b),C.set(J(b)),$()}),o?.addEventListener("keydown",p=>{p.key==="Escape"&&(F.set(""),C.set([]),o.value="",$())}),document.addEventListener("click",p=>{!p.target.closest("#search")&&!p.target.closest("#search-results")&&(C.set([]),$())}),document.querySelectorAll(".nav-btn").forEach((p,b)=>{p.addEventListener("click",()=>{ce(w[b].page),X()})}),y.addEventListener("click",()=>{x.set(!x()),ee(x()?D:U),y.innerHTML=x()?W:_,le(x())}),window.addEventListener("popstate",()=>{let p=window.location.hash.slice(1)||"home";w.some(b=>b.page===p)&&V.set(p)}),G(Ne),G($),ie()};document.addEventListener("DOMContentLoaded",$e);
