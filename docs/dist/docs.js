...
[Card, [[T, 'Hello']], { bg: '#f0f0f0' }]`},errorBoundaries:{description:"catch render errors and show fallback ui",interface:`interface ErrorBoundaryNode {
  ...
  return (
    ...
    </svg>`})},r=(e={},t=[])=>[i,t,{bg:"var(--bg-secondary)",p:16,r:8,s:{border:"1px solid var(--border)"}}],H=new Map,p=e=>{let t=`code-${Math.random().toString(36).slice(2,8)}`;return H.set(t,{code:e.code,lang:e.lang||"javascript"}),[m,"",{id:t,bg:"var(--code-bg)",r:4,ov:"auto",s:{maxHeight:"300px"}}]},ae=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),se=()=>{H.forEach(({code:e,lang:t},a)=>{let o=document.getElementById(a);o&&!o.querySelector("pre")&&(o.innerHTML=`<pre style="margin:0;padding:8px;font-size:12px;line-height:1.4;"><code class="language-${t}">${ae(e)}</code></pre>`)}),H.clear()},d=e=>[i,[[n,e.title,{fs:11,fw:400,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px",display:"block"}}],e.subtitle?[n,e.subtitle,{fs:13,fg:"var(--text-secondary)",m:"4px 0 0 0"}]:null].filter(Boolean),{m:"0 0 16px 0"}],Q=e=>{let{item:t,type:a}=e,o=[[c,[[n,a,{fs:10,fg:"var(--accent)",bg:"var(--bg-tertiary)",p:"2px 8px",r:4,s:{textTransform:"uppercase"}}],[n,t.name||t.op||t.fullName||"",{fs:18,fw:600,fg:"var(--text)"}]],{g:8,ai:"c"}],[n,t.description,{fg:"var(--text-secondary)",m:"8px 0 16px 0",s:{display:"block"}}]];return t.signature&&o.push(p({code:t.signature})),t.example&&o.push([i,[[n,"example",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px"}}],p({code:t.example})],{g:8,m:"16px 0"}]),r({},o)},ie={home:()=>[i,[[i,[[c,[[m,[J({size:48})],{w:48,h:48,s:{filter:"drop-shadow(0 4px 20px rgba(0,170,255,0.3))"}}],[i,[[n,"tooey",{fs:28,fw:700,fg:"var(--text)"}],[n,"token-efficient ui for llm output",{fs:14,fg:"var(--text-secondary)"}]],{g:4}]],{g:16,ai:"c"}],[c,[[n,"~39%",{fg:"var(--accent)",fw:600}],[n,"fewer tokens",{fg:"var(--text-secondary)"}],[n,"|",{fg:"var(--border)",m:"0 8px"}],[n,"~10kb",{fg:"var(--accent)",fw:600}],[n,"minified",{fg:"var(--text-secondary)"}],[n,"|",{fg:"var(--border)",m:"0 8px"}],[n,"0",{fg:"var(--accent)",fw:600}],[n,"deps",{fg:"var(--text-secondary)"}]],{g:6,ai:"c",flw:"wrap",m:"24px 0"}]],{m:"0 0 32px 0"}],r({},[d({title:"quick start"}),p({code:`import { render, V, T, B } from '@tooey/ui';
render(document.getElementById('app'), {
  s: { count: 0 },
  r: [V, [[T, { $: 'count' }], [B, '+', { c: 'count+' }]], { g: 8 }]
});`}),[c,[[B,"examples",{c:()=>Z("examples"),bg:"var(--accent)",fg:"#fff",p:"8px 16px",r:4,s:{border:"none",cursor:"pointer"}}],[U,"github",{href:"https://github.com/vijaypemmaraju/tooey",fg:"var(--text-secondary)",p:"8px 16px",s:{textDecoration:"none"}}]],{g:8,m:"16px 0 0 0"}]]),[h,[r({},[[n,"signals & reactivity",{fw:600,fg:"var(--text)",fs:14,s:{display:"block",marginBottom:"8px"}}],[n,"fine-grained reactivity with signals, computed, and effects",{fg:"var(--text-secondary)",fs:13}]]),r({},[[n,"function components",{fw:600,fg:"var(--text)",fs:14,s:{display:"block",marginBottom:"8px"}}],[n,"create reusable components as simple functions",{fg:"var(--text-secondary)",fs:13}]]),r({},[[n,"theming",{fw:600,fg:"var(--text)",fs:14,s:{display:"block",marginBottom:"8px"}}],[n,"token-based theming with $token syntax",{fg:"var(--text-secondary)",fs:13}]]),r({},[[n,"plugins",{fw:600,fg:"var(--text)",fs:14,s:{display:"block",marginBottom:"8px"}}],[n,"extend functionality with lifecycle hooks",{fg:"var(--text-secondary)",fs:13}]])],{cols:2,g:16,m:"24px 0"}],r({},[d({title:"components"}),[h,["layout","text","form","table","list","media"].map(e=>[i,[[n,e,{fg:"var(--accent)",fs:11,s:{textTransform:"uppercase",letterSpacing:"1px"}}],[n,s.components.filter(t=>t.category===e).map(t=>t.name).join(" "),{fg:"var(--text)",ff:"monospace"}]],{g:4}]),{cols:3,g:16}]])],{g:24}],"core-functions":()=>[i,[d({title:"core functions",subtitle:"essential functions for rendering and state management"}),...s.coreFunctions.map(e=>Q({item:e,type:"function"}))],{g:16}],"instance-methods":()=>[i,[d({title:"instance methods",subtitle:"methods on TooeyInstance returned by render()"}),...s.instanceMethods.map(e=>Q({item:e,type:"method"}))],{g:16}],components:()=>[i,[d({title:"components",subtitle:"22 built-in components with short names"}),...["layout","text","form","table","list","media"].map(e=>r({},[[n,e,{fs:13,fw:600,fg:"var(--accent)",s:{textTransform:"uppercase",marginBottom:"12px",display:"block"}}],[h,s.components.filter(t=>t.category===e).map(t=>[i,[[c,[[n,t.name,{fg:"var(--success)",fw:700,ff:"monospace",fs:16}],[n,`(${t.fullName})`,{fg:"var(--text-muted)",fs:12}]],{g:6,ai:"c"}],[n,t.description,{fg:"var(--text-secondary)",fs:12}],[n,t.element,{fg:"var(--text-muted)",fs:11,ff:"monospace"}]],{g:4,p:8,bg:"var(--bg-tertiary)",r:4}]),{cols:2,g:8}]]))],{g:16}],props:()=>[i,[d({title:"props",subtitle:"all style and element properties"}),...["spacing","sizing","colors","borders","positioning","typography","layout","misc","element"].map(e=>r({},[[n,e,{fs:13,fw:600,fg:"var(--accent)",s:{textTransform:"uppercase",marginBottom:"12px",display:"block"}}],[i,s.props.filter(t=>t.category===e).map(t=>[c,[[n,t.name,{fg:"var(--success)",fw:600,ff:"monospace",fs:13,w:40}],[n,t.fullName||"",{fg:"var(--text)",fs:13,w:120}],[n,t.description,{fg:"var(--text-secondary)",fs:12,s:{flex:"1"}}],[n,t.example||"",{fg:"var(--text-muted)",ff:"monospace",fs:11}]],{g:8,ai:"c",p:"6px 0",s:{borderBottom:"1px solid var(--border)"}}]),{g:0}]]))],{g:16}],events:()=>[i,[d({title:"events & operations",subtitle:"event handlers and state operations"}),r({},[[n,"events",{fs:13,fw:600,fg:"var(--accent)",s:{textTransform:"uppercase",marginBottom:"12px",display:"block"}}],[i,s.events.map(e=>[c,[[n,e.name,{fg:"var(--success)",fw:600,ff:"monospace",fs:14,w:40}],[n,e.fullName||"",{fg:"var(--text)",fs:13,w:100}],[n,e.description,{fg:"var(--text-secondary)",fs:12,s:{flex:"1"}}],[n,e.example||"",{fg:"var(--text-muted)",ff:"monospace",fs:11}]],{g:8,ai:"c",p:"8px 0",s:{borderBottom:"1px solid var(--border)"}}]),{g:0}]]),r({},[[n,"state operations",{fs:13,fw:600,fg:"var(--accent)",s:{textTransform:"uppercase",marginBottom:"12px",display:"block"}}],[i,s.stateOps.map(e=>[c,[[n,e.op||"",{fg:"var(--warning)",fw:700,ff:"monospace",fs:16,w:30,ta:"center"}],[n,e.name,{fg:"var(--text)",fs:13,w:80}],[n,e.description,{fg:"var(--text-secondary)",fs:12,s:{flex:"1"}}],[n,e.example||"",{fg:"var(--text-muted)",ff:"monospace",fs:11}]],{g:8,ai:"c",p:"8px 0",s:{borderBottom:"1px solid var(--border)"}}]),{g:0}]])],{g:16}],"control-flow":()=>[i,[d({title:"control flow",subtitle:"conditional rendering and list iteration"}),...s.controlFlow.map(e=>r({},[[n,e.name,{fs:14,fw:600,fg:"var(--text)",s:{display:"block",marginBottom:"8px"}}],[n,e.description,{fg:"var(--text-secondary)",fs:13,s:{display:"block",marginBottom:"12px"}}],p({code:e.example||""})]))],{g:16}],theming:()=>[i,[d({title:"theming",subtitle:"token-based theming system"}),r({},[[n,s.theming.description,{fg:"var(--text-secondary)",s:{display:"block",marginBottom:"16px"}}],[n,"interface",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px"}}],p({code:s.theming.interface})]),r({},[[n,"example",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px",marginBottom:"8px",display:"block"}}],p({code:s.theming.example})])],{g:16}],plugins:()=>[i,[d({title:"plugins",subtitle:"extend with lifecycle hooks"}),r({},[[n,s.plugins.description,{fg:"var(--text-secondary)",s:{display:"block",marginBottom:"16px"}}],p({code:s.plugins.interface})]),r({},[[n,"hooks",{fs:13,fw:600,fg:"var(--accent)",s:{textTransform:"uppercase",marginBottom:"12px",display:"block"}}],[i,s.plugins.hooks.map(e=>[c,[[n,e.name,{fg:"var(--success)",fw:600,ff:"monospace",fs:13,w:120}],[n,e.description,{fg:"var(--text-secondary)",fs:12,s:{flex:"1"}}]],{g:8,ai:"c",p:"8px 0",s:{borderBottom:"1px solid var(--border)"}}]),{g:0}]]),r({},[[n,"example",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px",marginBottom:"8px",display:"block"}}],p({code:s.plugins.example})])],{g:16}],"function-components":()=>[i,[d({title:"function components",subtitle:"create reusable components"}),r({},[[n,s.functionComponents.description,{fg:"var(--text-secondary)",s:{display:"block",marginBottom:"16px"}}],p({code:s.functionComponents.signature})]),r({},[[n,"example",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px",marginBottom:"8px",display:"block"}}],p({code:s.functionComponents.example})])],{g:16}],"error-boundaries":()=>[i,[d({title:"error boundaries",subtitle:"catch render errors gracefully"}),r({},[[n,s.errorBoundaries.description,{fg:"var(--text-secondary)",s:{display:"block",marginBottom:"16px"}}],p({code:s.errorBoundaries.interface})]),r({},[[n,"example",{fs:11,fg:"var(--text-muted)",s:{textTransform:"uppercase",letterSpacing:"1px",marginBottom:"8px",display:"block"}}],p({code:s.errorBoundaries.example})])],{g:16}],types:()=>[i,[d({title:"types",subtitle:"typescript type definitions"}),...s.types.map(e=>r({},[[n,e.name,{fg:"var(--success)",fw:600,ff:"monospace",fs:14}],[n,e.description,{fg:"var(--text-secondary)",fs:13,m:"8px 0"}],p({code:e.signature||""})]))],{g:16}],examples:()=>[i,[d({title:"examples",subtitle:"interactive demos with token comparisons"}),[i,s.examples.map(e=>r({},[[c,[[n,e.name,{fg:"var(--text)",fw:600,fs:16}],[n,e.savings,{fg:"var(--success)",fw:700,ff:"monospace",fs:14}]],{jc:"sb",ai:"c"}],[n,e.description,{fg:"var(--text-secondary)",fs:13,m:"8px 0 16px 0"}],[h,[[i,[[c,[[n,"tooey",{fg:"var(--accent)",fs:11,s:{textTransform:"uppercase",letterSpacing:"1px"}}],[n,`(${e.tooeyTokens} tokens)`,{fg:"var(--text-muted)",fs:11}]],{g:8,ai:"c"}],p({code:e.tooeyCode,lang:"javascript"})],{g:8}],[i,[[c,[[n,"react",{fg:"var(--warning)",fs:11,s:{textTransform:"uppercase",letterSpacing:"1px"}}],[n,`(${e.reactTokens} tokens)`,{fg:"var(--text-muted)",fs:11}]],{g:8,ai:"c"}],p({code:e.reactCode,lang:"jsx"})],{g:8}]],{cols:2,g:16}],[n,"live demos",{fg:"var(--text-muted)",fs:11,s:{textTransform:"uppercase",letterSpacing:"1px"},m:"16px 0 8px 0"}],[h,[[i,[[n,"tooey",{fg:"var(--accent)",fs:10,s:{textTransform:"uppercase",letterSpacing:"1px"}}],[m,"",{id:`demo-tooey-${e.id}`,bg:"var(--bg-tertiary)",p:16,r:8,s:{border:"1px solid var(--border)",minHeight:"100px"}}]],{g:8}],[i,[[n,"react",{fg:"var(--warning)",fs:10,s:{textTransform:"uppercase",letterSpacing:"1px"}}],[m,"",{id:`demo-react-${e.id}`,bg:"var(--bg-tertiary)",p:16,r:8,s:{border:"1px solid var(--border)",minHeight:"100px"}}]],{g:8}]],{cols:2,g:16}]])),{g:24}]],{g:16}]},j={},D={};s.examples.forEach(e=>{j[e.id]=e.demoSpec,D[e.id]=e.reactDemoCode});var w=[{label:"home",page:"home"},{label:"core functions",page:"core-functions"},{label:"instance methods",page:"instance-methods"},{label:"components",page:"components"},{label:"props",page:"props"},{label:"events & ops",page:"events"},{label:"control flow",page:"control-flow"},{label:"theming",page:"theming"},{label:"plugins",page:"plugins"},{label:"function components",page:"function-components"},{label:"error boundaries",page:"error-boundaries"},{label:"types",page:"types"},{label:"examples",page:"examples"}],V=E(window.location.hash.slice(1)||"home"),M=E(""),T=E([]),x=E(window.matchMedia("(prefers-color-scheme: dark)").matches),I,v,Z=e=>{window.location.hash=e,V.set(e),M.set(""),T.set([])},X=!1,re=()=>X?Promise.resolve():new Promise(e=>{let t=document.createElement("link");t.rel="stylesheet",t.href="https://unpkg.com/prismjs@1/themes/prism-tomorrow.min.css",document.head.appendChild(t);let a=document.createElement("script");a.src="https://unpkg.com/prismjs@1/prism.min.js",a.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/prismjs@1/components/prism-jsx.min.js",o.onload=()=>{let g=document.createElement("script");g.src="https://unpkg.com/prismjs@1/components/prism-typescript.min.js",g.onload=()=>{X=!0,e()},document.head.appendChild(g)},document.head.appendChild(o)},document.head.appendChild(a)}),ce=()=>{let e=window.Prism;e&&e.highlightAll()},_=!1,le=()=>_?Promise.resolve():new Promise(e=>{let t=document.createElement("script");t.src="https://unpkg.com/react@18/umd/react.development.js",t.crossOrigin="anonymous",t.onload=()=>{let a=document.createElement("script");a.src="https://unpkg.com/react-dom@18/umd/react-dom.development.js",a.crossOrigin="anonymous",a.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/@babel/standalone/babel.min.js",o.onload=()=>{_=!0,e()},document.head.appendChild(o)},document.head.appendChild(a)},document.head.appendChild(t)}),pe=(e,t)=>{try{let a=window.Babel,o=window.React,g=window.ReactDOM;if(!a||!o||!g)return;let f=a.transform(t,{presets:["react"]}).code,k=new Function("React",`${f}; return ${t.match(/function\s+(\w+)/)?.[1]||"Component"};`)(o);g.createRoot(e).render(o.createElement(k)),e.dataset.rendered="true"}catch(a){console.warn("[tooey] failed to render react demo:",a),e.textContent="failed to render"}},de=()=>{if(!I)return;let e=V();I.innerHTML="",L(I,{r:ie[e]()}),Y(),se(),re().then(ce),document.querySelectorAll(".nav-btn").forEach((t,a)=>{let o=t;o.style.background=w[a].page===e?"var(--bg-tertiary)":"transparent",o.style.color=w[a].page===e?"var(--accent)":"var(--text-secondary)"}),e==="examples"&&(Object.keys(j).forEach(t=>{let a=document.getElementById(`demo-tooey-${t}`);if(a&&!a.dataset.rendered)try{let o=JSON.parse(j[t]);L(a,o),a.dataset.rendered="true"}catch(o){console.warn("[tooey] failed to render demo:",t,o)}}),le().then(()=>{Object.keys(D).forEach(t=>{let a=document.getElementById(`demo-react-${t}`);a&&!a.dataset.rendered&&pe(a,D[t])})}))},N=()=>{if(!v)return;let e=T();if(!e.length){v.innerHTML="";return}v.innerHTML="",L(v,{r:[i,e.slice(0,10).map(t=>[m,[[c,[[n,t.type,{fs:9,fg:"var(--accent)",bg:"var(--bg-tertiary)",p:"2px 6px",r:2,s:{textTransform:"uppercase"}}],[n,t.name,{fg:"var(--text)",fw:500,fs:13}]],{g:6,ai:"c"}],[n,t.description,{fg:"var(--text-secondary)",fs:11}]],{p:8,r:4,cur:"pointer",cls:"search-result"}]),{pos:"abs",t:42,l:0,rt:0,bg:"var(--bg-secondary)",r:4,p:8,z:100,mh:300,ov:"auto",s:{border:"1px solid var(--border)",boxShadow:"0 4px 20px rgba(0,0,0,0.3)"}}]})},me=()=>{G(x()?$:W);let e=document.getElementById("app");if(!e)return;let t={s:{},r:[c,[[B,"",{id:"menu-btn",pos:"fix",t:16,l:16,z:1001,bg:"var(--bg-secondary)",p:10,r:8,s:{border:"1px solid var(--border)",display:"none"}}],[m,"",{id:"sidebar-overlay",pos:"fix",t:0,l:0,w:"100vw",h:"100vh",z:999,bg:"rgba(0,0,0,0.5)",s:{display:"none"}}],[i,[[c,[J({size:32}),[n,"tooey",{fs:18,fw:700,fg:"var(--text)"}]],{g:8,ai:"c",m:"0 0 24px 0"}],[i,[[ne,"",{ph:"search...",bg:"var(--bg-tertiary)",fg:"var(--text)",p:"8px 12px",r:4,w:"100%",s:{border:"1px solid var(--border)",outline:"none"},id:"search"}]],{pos:"rel",m:"0 0 16px 0"}],[m,"",{id:"search-results"}],[i,w.map(l=>[B,l.label,{bg:"transparent",fg:"var(--text-secondary)",p:"8px 12px",r:4,w:"100%",ta:"left",fs:13,cur:"pointer",s:{border:"none"},cls:"nav-btn"}]),{g:2}],[c,[[B,"",{bg:"transparent",fg:"var(--text-secondary)",p:8,r:4,cur:"pointer",s:{border:"none"},id:"theme-btn"}],[U,"",{href:"https://github.com/vijaypemmaraju/tooey",fg:"var(--text-secondary)",p:8,id:"github-link"}]],{g:8,m:"auto 0 0 0"}]],{w:240,h:"100vh",p:24,bg:"var(--bg-secondary)",pos:"fix",t:0,l:0,z:1e3,s:{borderRight:"1px solid var(--border)",overflowY:"auto",display:"flex",flexDirection:"column",transition:"transform 0.3s ease"},id:"sidebar"}],[m,[{boundary:!0,child:[m,"",{id:"page-content"}],fallback:r({},[[n,"error",{fg:"var(--error)",fw:600}]]),onError:l=>console.error(l)}],{m:"0 0 0 240px",p:32,mw:900,s:{minHeight:"100vh"},id:"main-content"}]],{w:"100%"}]};L(e,t,{plugins:[oe]}),I=document.getElementById("page-content"),v=document.getElementById("search-results");let a=document.getElementById("search"),o=document.getElementById("theme-btn"),g=document.getElementById("github-link"),f=document.getElementById("menu-btn"),k=document.getElementById("sidebar"),C=document.getElementById("sidebar-overlay"),b=document.getElementById("main-content"),q='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>',z='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>',K='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.386-1.332-1.755-1.332-1.755-1.089-.744.083-.729.083-.729 1.205.085 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.605-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 21.795 24 17.295 24 12c0-6.63-5.37-12-12-12z"/></svg>',R='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12h18M3 6h18M3 18h18"/></svg>',ee='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6L6 18M6 6l12 12"/></svg>';o.innerHTML=x()?q:z,g.innerHTML=K,f.innerHTML=R;let P=window.innerWidth<=768,u=!1,S=()=>{P=window.innerWidth<=768,P?(f.style.display="block",k.style.transform=u?"translateX(0)":"translateX(-100%)",C.style.display=u?"block":"none",b.style.marginLeft="0",b.style.padding="16px",b.style.paddingTop="60px"):(f.style.display="none",k.style.transform="translateX(0)",C.style.display="none",b.style.marginLeft="240px",b.style.padding="32px",u=!1)},te=()=>{u=!u,f.innerHTML=u?ee:R,S()},A=()=>{u&&(u=!1,f.innerHTML=R,S())};f.addEventListener("click",te),C.addEventListener("click",A),window.addEventListener("resize",S),S(),a?.addEventListener("input",l=>{let y=l.target.value;M.set(y),T.set(O(y)),N()}),a?.addEventListener("keydown",l=>{l.key==="Escape"&&(M.set(""),T.set([]),a.value="",N())}),document.addEventListener("click",l=>{!l.target.closest("#search")&&!l.target.closest("#search-results")&&(T.set([]),N())}),document.querySelectorAll(".nav-btn").forEach((l,y)=>{l.addEventListener("click",()=>{Z(w[y].page),A()})}),o.addEventListener("click",()=>{x.set(!x()),G(x()?$:W),o.innerHTML=x()?q:z}),window.addEventListener("popstate",()=>{let l=window.location.hash.slice(1)||"home";w.some(y=>y.page===l)&&V.set(l)}),F(de),F(N),Y()};document.addEventListener("DOMContentLoaded",me);
