...
// console: window.__TOOEY_DEVTOOLS__.getState()`})])],{cls:"space-y-4"}]},H={},q={};r.examples.forEach(e=>{H[e.id]=e.demoSpec,q[e.id]=e.reactDemoCode});var v=[{label:"home",page:"home"},{label:"core functions",page:"core-functions"},{label:"instance methods",page:"instance-methods"},{label:"components",page:"components"},{label:"props",page:"props"},{label:"events & ops",page:"events"},{label:"control flow",page:"control-flow"},{label:"theming",page:"theming"},{label:"plugins",page:"plugins"},{label:"function components",page:"function-components"},{label:"error boundaries",page:"error-boundaries"},{label:"advanced features",page:"advanced-features"},{label:"types",page:"types"},{label:"examples",page:"examples"}],z=I(window.location.hash.slice(1)||"home"),P=I(""),k=I([]),f=I(window.matchMedia("(prefers-color-scheme: dark)").matches),N,h,te=e=>{window.location.hash=e,z.set(e),P.set(""),k.set([])},J=!1,T=null,ne=e=>{T||(T=document.createElement("style"),document.head.appendChild(T)),T.textContent=e?`
  ...
  `},ge=()=>J?Promise.resolve():new Promise(e=>{ne(f());let n=document.createElement("script");n.src="https://unpkg.com/prismjs@1/prism.min.js",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/prismjs@1/components/prism-jsx.min.js",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/prismjs@1/components/prism-typescript.min.js",o.onload=()=>{J=!0,e()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),fe=()=>{let e=window.Prism;e&&document.querySelectorAll('code[class*="language-"]').forEach(n=>{n.classList.contains("prism-highlighted")||(e.highlightElement(n),n.classList.add("prism-highlighted"))})},Y=!1,xe=()=>Y?Promise.resolve():new Promise(e=>{let n=document.createElement("script");n.src="https://unpkg.com/react@18/umd/react.development.js",n.crossOrigin="anonymous",n.onload=()=>{let s=document.createElement("script");s.src="https://unpkg.com/react-dom@18/umd/react-dom.development.js",s.crossOrigin="anonymous",s.onload=()=>{let o=document.createElement("script");o.src="https://unpkg.com/@babel/standalone/babel.min.js",o.onload=()=>{Y=!0,e()},document.head.appendChild(o)},document.head.appendChild(s)},document.head.appendChild(n)}),ye=(e,n)=>{try{let s=window.Babel,o=window.React,x=window.ReactDOM;if(!s||!o||!x)return;let L=s.transform(n,{presets:["react"]}).code,u=new Function("React",`${L}; return ${n.match(/function\s+(\w+)/)?.[1]||"Component"};`)(o);x.createRoot(e).render(o.createElement(u)),e.dataset.rendered="true"}catch(s){console.warn("[tooey] failed to render react demo:",s),e.textContent="failed to render"}},be=()=>{if(!N)return;let e=z();N.innerHTML="",$(N,{r:ue[e]()}),ee(),requestAnimationFrame(()=>{me(),ge().then(()=>{requestAnimationFrame(fe)})}),document.querySelectorAll(".nav-btn").forEach((n,s)=>{let o=n;o.style.background=v[s].page===e?"var(--bg-tertiary)":"transparent",o.style.color=v[s].page===e?"var(--accent)":"var(--text-secondary)"}),e==="examples"&&(Object.keys(H).forEach(n=>{let s=document.getElementById(`demo-tooey-${n}`);if(s&&!s.dataset.rendered)try{let o=JSON.parse(H[n]);$(s,o),s.dataset.rendered="true"}catch(o){console.warn("[tooey] failed to render demo:",n,o)}}),xe().then(()=>{Object.keys(q).forEach(n=>{let s=document.getElementById(`demo-react-${n}`);s&&!s.dataset.rendered&&ye(s,q[n])})}))},C=()=>{if(!h)return;let e=k();if(!e.length){h.innerHTML="";return}h.innerHTML="",$(h,{r:[a,e.slice(0,10).map(n=>[m,[[c,[[t,n.type,{cls:"text-[9px] text-accent bg-bg-tertiary px-1.5 py-0.5 rounded uppercase"}],[t,n.name,{cls:"text-text-primary font-medium text-sm"}]],{cls:"gap-1.5 items-center flex"}],[t,n.description,{cls:"text-text-secondary text-xs"}]],{cls:"search-result p-2 rounded cursor-pointer hover:bg-bg-tertiary transition-colors"}]),{cls:"absolute top-[42px] left-0 right-0 bg-bg-secondary rounded p-2 z-[100] max-h-[300px] overflow-auto border border-border shadow-lg"}]})},Z=ie(),he=()=>{X(f()?E:Q),le();let e=document.getElementById("app");if(!e)return;let n=ce({name:"tooey-docs",log:!1}),s={s:{},r:[c,[[S,"",{id:"menu-btn",cls:"fixed top-4 left-4 z-[1001] bg-bg-secondary p-2.5 rounded-lg border border-border hidden"}],[m,"",{id:"sidebar-overlay",cls:"fixed inset-0 z-[999] bg-black/50 hidden"}],[a,[[c,[U({size:32}),[t,"tooey",{cls:"text-lg font-bold text-text-primary"}]],{cls:"gap-2 items-center flex mb-6"}],[a,[[re,"",{ph:"search...",id:"search",rf:Z,cls:"bg-bg-tertiary text-text-primary px-3 py-2 rounded w-full border border-border outline-none focus:border-accent"}],[m,"",{id:"search-results"}]],{cls:"relative mb-4"}],[a,v.map(d=>[S,d.label,{cls:"nav-btn bg-transparent text-text-secondary px-3 py-2 rounded w-full text-left text-sm cursor-pointer border-none hover:bg-bg-tertiary hover:text-accent transition-colors"}]),{cls:"gap-0.5"}],[c,[[S,"",{id:"theme-btn",cls:"bg-transparent text-text-secondary p-2 rounded cursor-pointer border-none hover:text-accent transition-colors"}],[K,"",{href:"https://github.com/vijaypemmaraju/tooey",id:"github-link",cls:"text-text-secondary p-2 hover:text-accent transition-colors"}]],{cls:"gap-2 mt-auto"}]],{id:"sidebar",cls:"w-60 h-screen p-6 bg-bg-secondary fixed top-0 left-0 z-[1000] border-r border-border overflow-y-auto flex flex-col transition-transform duration-300"}],[m,[{boundary:!0,child:[m,"",{id:"page-content"}],fallback:i({},[[t,"error",{cls:"text-error font-semibold"}]]),onError:d=>console.error(d)}],{id:"main-content",cls:"ml-60 p-8 max-w-[900px] min-h-screen"}]],{cls:"w-full"}]};$(e,s,{plugins:[de,n]}),N=document.getElementById("page-content"),h=document.getElementById("search-results");let o=Z.el,x=document.getElementById("theme-btn"),L=document.getElementById("github-link"),u=document.getElementById("menu-btn"),B=document.getElementById("sidebar"),R=document.getElementById("sidebar-overlay"),b=document.getElementById("main-content"),V='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>',A='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>',oe='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.386-1.332-1.755-1.332-1.755-1.089-.744.083-.729.083-.729 1.205.085 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.605-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 21.795 24 17.295 24 12c0-6.63-5.37-12-12-12z"/></svg>',j='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12h18M3 6h18M3 18h18"/></svg>',se='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6L6 18M6 6l12 12"/></svg>';x.innerHTML=f()?V:A,L.innerHTML=oe,u.innerHTML=j;let O=window.innerWidth<=768,g=!1,w=()=>{O=window.innerWidth<=768,O?(u.style.display="block",B.style.transform=g?"translateX(0)":"translateX(-100%)",R.style.display=g?"block":"none",b.style.marginLeft="0",b.style.padding="16px",b.style.paddingTop="60px"):(u.style.display="none",B.style.transform="translateX(0)",R.style.display="none",b.style.marginLeft="240px",b.style.padding="32px",g=!1)},ae=()=>{g=!g,u.innerHTML=g?se:j,w()},F=()=>{g&&(g=!1,u.innerHTML=j,w())};u.addEventListener("click",ae),R.addEventListener("click",F),window.addEventListener("resize",w),w(),o?.addEventListener("input",d=>{let y=d.target.value;P.set(y),k.set(W(y)),C()}),o?.addEventListener("keydown",d=>{d.key==="Escape"&&(P.set(""),k.set([]),o.value="",C())}),document.addEventListener("click",d=>{!d.target.closest("#search")&&!d.target.closest("#search-results")&&(k.set([]),C())}),document.querySelectorAll(".nav-btn").forEach((d,y)=>{d.addEventListener("click",()=>{te(v[y].page),F()})}),x.addEventListener("click",()=>{f.set(!f()),X(f()?E:Q),x.innerHTML=f()?V:A,ne(f())}),window.addEventListener("popstate",()=>{let d=window.location.hash.slice(1)||"home";v.some(y=>y.page===d)&&z.set(d)}),_(be),_(C),ee()};document.addEventListener("DOMContentLoaded",he);
